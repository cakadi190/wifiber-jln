...
class _ListMikrotikScreenState extends State<ListMikrotikScreen>
  ...
  Widget _buildPppoeCard(RouterPppoeSecret secret, {required bool isActive}) {
    ...
    final pppoeDisconnectReasonMapping = {
      'hung-up': 'Koneksi Terputus',
      'lost-carrier': 'Sinyal Hilang (Lost Carrier)',
      'loss-connection': 'Kehilangan Koneksi',
      'peer-hung-up': 'Client Memutus Koneksi',
      'ppp-timeout': 'PPP Waktu Habis',
      'authentication-failure': 'Gagal Autentikasi',
      'nas-request': 'Permintaan NAS',
      'no-response': 'Tidak Ada Respons',
      'terminated': 'Sesi Dihentikan',
      'session-limit': 'Batas Sesi Tercapai',
      'service-unavailable': 'Layanan Tidak Tersedia',
      'peer-initiated': 'Diputus oleh Client',
      'server-initiated': 'Diputus oleh Server',
      'radius-timeout': 'RADIUS Waktu Habis',
      'radius-reject': 'RADIUS Menolak Login',
      'disconnect-request': 'Permintaan Pemutusan',
      'profile-change': 'Perubahan Profil',
      'peer-request': 'Permintaan Client',
      'idle-timeout': 'Waktu Diam Terlampaui (Idle)',
      'connect-failed': 'Gagal Menghubungkan',
      'authentication-timeout': 'Waktu Autentikasi Habis',
      'user-request': 'Permintaan Pengguna',
      'admin-reset': 'Direset oleh Admin',
      'admin-shutdown': 'Dimatikan oleh Admin',
      'port-error': 'Kesalahan Port',
      'not-enough-resources': 'Sumber Daya Tidak Mencukupi',
      'link-failure': 'Kegagalan Link',
      'lost-service': 'Layanan Hilang',
      'no-carrier': 'Sinyal Tidak Ada',
      'mru-negotiation-failed': 'Gagal Negosiasi MRU',
      'lcp-termination': 'Terminasi LCP',
      'ccp-termination': 'Terminasi CCP',
      'keepalive-timeout': 'Keepalive Timeout',
      'host-unreachable': 'Host Tidak Terjangkau',
      'internal-error': 'Kesalahan Internal',
      'reboot': 'Router Reboot',
      'forced-termination': 'Terminasi Paksa',
