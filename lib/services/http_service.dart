...
class HttpService {
  ...
  // Convenience method for single file upload with POST
  ...
  // Convenience method for multiple files upload with POST
  ...
  Future<Map<String, String>> _buildMultipartHeaders(
    ...
    try {
      ...
      // Note: Content-Type akan di-set otomatis oleh MultipartRequest
