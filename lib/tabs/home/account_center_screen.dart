...
import 'package:wifiber/screens/dashboard/broadcast/broadcast_whatsapp_screen.dart';
  ...
  Widget _buildActionTileLists(BuildContext context) {
    return Consumer<AuthProvider>(
      builder: (context, authProvider, child) {
        ...
        final hasIntegrationPermission =
            user?.permissions.contains('integration') ?? false;
          ...
          children: [
            ...
            if (hasIntegrationPermission)
              ListTile(
                ...
                onTap: () {
                  _accountCenterController.navigateToScreen(
                    screen: const BroadcastWhatsappScreen(),
                    context: context,
                  );
                },
              ),
